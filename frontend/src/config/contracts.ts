export const FUNDRAISE_ADDRESS = '0x33134B3c6E797eEE05eF41E01e8E00C1410f02B5';
export const CUSDT_ADDRESS = '0xDc5345e0bf6c06F237bC83535B6bE49DCc8FDf55';

export const FUNDRAISE_ABI = [
  {
    "inputs": [
      {
  ...
  {
    "inputs": [],
    "name": "ActiveCampaignAlreadyExists",
    "type": "error"
  },
  {
    "inputs": [],
